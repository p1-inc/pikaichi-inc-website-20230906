...
const contentProfile = {
    ...
    career: {
        key: "経歴",
        content: ["武蔵野美術大学 視覚伝達デザイン科卒", "株式会社アサツー ディ・ケイを経て", "株式会社ピカイチを設立"],
    },
    awards: {
        key: "賞歴",
        content: [
    ...
    summary: {
        key: "概要",
        content: [
            "株式会社ピカイチは、アートディレクター清水 光を代表とするデザイン会社。 代表の清水は、美術大学でデザインを学び、大手広告代理店アサツーディ・ケイにて12年間アートディレクターとして業務に携わってきた。のちに、独立し株式会社ピカイチを創立。株式会社ピカイチでの業務内容は、グラフィックデザイン、パッケージデザイン、ロゴ、CI、VI、CM企画まで、大手上場企業のブランディングや販売促進など、幅広くクリエイティブ活動を行ってきた。 2012年から現在まで活動中。",
        ],
    },
};
